                        ...
                        <main class="col-md-12">
                            ...
                            <header class="border-bottom mb-4 pb-3">
                                <div class="form-inline">
                                    <span class="mr-md-auto">Gym Equipment: 24 Items found </span>
                                </div>
                            </header>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <figure class="card card-product-grid">
                                        <div class="img-wrap">
                                            ...
                                            <asp:ImageButton ID="ImageButton1" runat="server" Style="height: 150px" src="/images/ProductImage/gym1.jpeg" OnClick="ImageButton1_Click" />
                                        ...
                                        <figcaption class="info-wrap">
                                            <div class="fix-height">
                                                <a href="#" class="title">Gym Equipment</a>
                                                <div class="price-wrap mt-2">
                                                    <del class="price-old text-danger">₹1900</del>
                                                    <span class="price text-success">&nbsp ₹1200</span>
                                    ...
                                    <figure class="card card-product-grid">
                                        ...
                                        <figcaption class="info-wrap">
                                            <div class="fix-height">
                                                <a href="#" class="title">Gym Equipment</a>
                                                <div class="price-wrap mt-2">
                                                    <del class="price-old text-danger">₹1200</del>
                                                    <span class="price text-success">&nbsp ₹1100</span>
                                                </div>
                                                <!-- price-wrap.// -->
                                ...
                                <div class="col-md-4">
                                    <figure class="card card-product-grid">
                                        <div class="img-wrap">
                                            ...
                                            <asp:ImageButton ID="ImageButton3" runat="server" Style="height: 150px" src="/images/ProductImage/gym3.jpeg" OnClick="ImageButton3_Click" />
                                ...
                                <div class="col-md-4">
                                    <figure class="card card-product-grid">
                                        <div class="img-wrap">
                                            ...
                                            <asp:ImageButton ID="ImageButton4" runat="server" Style="height: 150px" src="/images/ProductImage/gym4.jpeg" OnClick="ImageButton4_Click" />
                                        ...
                                        <figcaption class="info-wrap">
                                            <div class="fix-height">
                                                <a href="#" class="title">Gym Equipmen</a>
                                                <div class="price-wrap mt-2">
