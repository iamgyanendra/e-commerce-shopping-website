    ...
    public partial class CancelOrder : System.Web.UI.Page
    {
        ...
        protected void COrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry2 = "Delete from Orderdetails where custid=@t1 and orderNo=@t2"; //Sql Query
                SqlCommand cmd2 = new SqlCommand(qry2, con); //send query execution
                cmd2.Parameters.AddWithValue("@t1", Session["cid"].ToString());
                cmd2.Parameters.AddWithValue("@t2", TextBox1.Text.ToString());
                SqlDataReader dr2 = cmd2.ExecuteReader();
                dr2.Read();
                Label1.Text = "your order successfully canceld";
            }
